        ...
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    ...
                    <div className="max-w-[1920px] mx-auto px-4 sm:px-8 py-3 sm:py-3.5 flex items-center justify-between gap-4">
                        {/* Content */}
                        <div className="flex-1 flex flex-col sm:flex-row items-center justify-center gap-x-6 gap-y-1 text-center sm:text-left overflow-hidden">
                            ...
                            <a 
                                ...
                                className="group flex items-center gap-1.5 text-xs font-heading font-black uppercase tracking-[2px] text-[#1e1e3f] hover:text-[var(--color-accent-purple)] transition-colors py-1"
                            >
