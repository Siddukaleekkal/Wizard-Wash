        ...
        <section className="relative w-full h-[70vh] min-h-[600px] lg:h-[80vh] overflow-hidden bg-black border-b-4 border-[#9138df]">
            ...
            <div className="relative z-20 max-w-[1920px] mx-auto px-6 lg:px-20 h-full flex flex-col justify-center text-left">
                <div className="max-w-4xl">
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-black text-white leading-[1.1] mb-6 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] uppercase tracking-tight">
                        <span className="block mb-2">The Standard in</span>
                        <span className="relative flex w-full overflow-hidden md:pb-4 text-[#9138df] min-h-[1.2em]">
