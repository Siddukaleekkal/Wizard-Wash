                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-wrap justify-center gap-16 gap-y-20">
                        {[
                            ...
                            { name: "Siddu Kaleekkal", role: "CTO", img: "/images/Siddu%20Kaleekkal%20CTO.jpg", desc: "Driving technological innovation and ensuring a seamless digital experience for our clients.", imgClass: "object-top", email: "siddu@wizardwashva.com" },
