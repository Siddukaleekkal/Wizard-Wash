...
const SERVICES_DATA = {
    ...
    "concrete-wash-seal": {
        ...
        image: "https://images.unsplash.com/photo-1516880711640-ef7db81be3e1?q=80&w=2670&auto=format&fit=crop",
    ...
    "annual-wash": {
        ...
        image: "https://images.unsplash.com/photo-1521791055366-0d553872125f?q=80&w=2670&auto=format&fit=crop",
    ...
    "brick-stone": {
        ...
        image: "https://images.unsplash.com/photo-1544911845-1f34a3eb46b1?q=80&w=2670&auto=format&fit=crop",
    ...
    "wood-wash": {
        ...
        image: "https://images.unsplash.com/photo-1585044453911-3729e0618cc9?q=80&w=2670&auto=format&fit=crop",
    ...
    "christmas-lights": {
        ...
        image: "https://images.unsplash.com/photo-1543509172-680f4f91048b?q=80&w=2670&auto=format&fit=crop",
    ...
    "diwali-lights": {
        ...
        image: "https://images.unsplash.com/photo-1514222134-b57cbb8ce073?q=80&w=2670&auto=format&fit=crop",
    ...
    "hanukkah-lights": {
        ...
        image: "https://images.unsplash.com/photo-1575293263720-6d80ff5f58c7?q=80&w=2670&auto=format&fit=crop",
    ...
    "fleet-washing": {
        ...
        features: ["Mobile on-site service", "Water recovery compliant", "Bi-weekly or monthly plans", "Degreasing & detailing"]
    },
    "offices": {
    ...
    "restaurants": {
        ...
        category: "Commercial",
        description: "High-traffic food service environments require heavy-duty sanitation to meet health standards and customer expectations. We specialize in high-temperature steam cleaning (200°F+) to melt away grease build-up from dumpster pads, drive-thru lanes, and outdoor seating areas. Our specialized enzymes eliminate the organic odors that can turn customers away. By maintaining a spotless exterior, you communicate a standard of cleanliness that starts the moment a guest pulls into your lot, ensuring their first impression is flawless.",
        image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=80&w=2670&auto=format&fit=crop",
    ...
    "government": {
        ...
        image: "https://images.unsplash.com/photo-1557160854-e1e89fdd3286?q=80&w=2670&auto=format&fit=crop",
            ...
            <section className="relative pt-32 pb-16 lg:pt-48 lg:pb-32 px-6">
                ...
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <motion.div
                        ...
                        className="space-y-8"
                    >
                        <h1 className="text-[#1e1e3f] text-5xl md:text-8xl font-heading font-black tracking-tighter leading-[0.95] uppercase">
                            {service.title}
                        </h1>
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="absolute inset-0 bg-gradient-to-tr from-[#9138df]/20 to-blue-400/20 rounded-[40px] blur-2xl -z-10" />
            ...
            <section className="bg-slate-50 py-24 px-6 border-y border-slate-200">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 space-y-4">
                        <h2 className="text-[#1e1e3f] text-3xl md:text-5xl font-heading font-black uppercase tracking-tight">Service Standards</h2>
                        <div className="h-1 w-20 bg-[#9138df] mx-auto" />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                        {service.features.map((feature, idx) => (
                            ...
                            >
                                <CheckCircle2 size={32} className="text-[#9138df]" />
                                <h3 className="font-heading font-black text-[#1e1e3f] uppercase tracking-wide text-xl leading-tight">
                                    {feature}
                                </h3>
                            </motion.div>
                        ))}
